...
insert into account(id,player_name,gender,date_created,version) values (1000,'foobar1','M',now(),0);
insert into account(id,player_name,gender,date_created,version) values (2000,'foobar2','M',now(),0);
insert into account(id,player_name,gender,date_created,version) values (3000,'foobar3','F',now(),0);
